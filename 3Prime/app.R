...
ui <- dashboardPage(skin = "purple",
                    ...
                    Sidebar <- dashboardSidebar(
                      sidebarMenu(
                        ...
                        menuItem("Kallisto-Sleuth Pipeline", 
                                 menuSubItem("FastQC", tabName = "FastQC", icon = icon("fire")),
                                 menuSubItem("Alignment Data Input", tabName = "RawDataInput", icon = icon("fire")),
                                 menuSubItem("QC", tabName = "QC", icon = icon("fire")),
                                 menuSubItem("Sleuth Object", tabName = "Sleuth", icon = icon("fire")),
                                 menuSubItem("PCA", tabName = "PCA", icon = icon("fire")),
                                 menuSubItem("Statistical Analysis", tabName = "Computation", icon = icon("fire")),
                                 menuSubItem("Volcano Plot", tabName = "Volcano", icon = icon("fire")),
                                 menuSubItem("Transcript Abundance", tabName = "Transcript", icon = icon("fire"))),
                        menuItem("edgeR Pipeline", 
                                 menuSubItem("Data Input", tabName = "edgeDataInputs", icon = icon("fire")),
                                 menuSubItem("QC", tabName = "edgeQC", icon = icon("fire")),
                                 menuSubItem("Statistical Analysis", tabName = "edgeStat", icon = icon("fire"))),
                        menuItem("scRNA-Seq Pipeline", 
                                 menuSubItem("Data Input", tabName = "edgeDataInputs", icon = icon("fire")),
                                 menuSubItem("QC", tabName = "edgeQC", icon = icon("fire")),
                                 menuSubItem("Statistical Analysis", tabName = "edgeStat", icon = icon("fire"))),
                        menuItem("Logout", tabName = "Logout", icon = icon("gear"))
                      )
                    ),
